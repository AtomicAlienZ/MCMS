 ...
 * email_message.php
 *
 * @(#) $Header: /home/mlemos/cvsroot/PHPlibrary/email_message.php,v 1.19 2002/08/14 21:54:35 mlemos Exp $
 *
 *
 */
...
class email_message_class
{
	...
	//var $mailer='http://www.phpclasses.org/mimemessage $Revision: 1.19 $';
	var $default_charset="utf-8";
	var $line_break="\r\n";
	var $file_buffer_length=8000;
	var $debug="trigger_error";
	var $error="";
	...
	Function OutputError($error)
	{
		## daiz13
		## ���� ����������� ��� �������
        if ( !empty($this->debug) &&  !empty($error) ) {
            $function=$this->debug;
			$function($error);
			}
